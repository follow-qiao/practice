...
// 默认时间：500
// 运动时间：easeOut
qy.animation = function (obj, attrs, duration, fx, fn){
...
// 抖函数
qy.shake = function (obj, attr, nums, fn){
  if(obj.shake) return;
  var arr = [], _this = this;
...
qy.setTransform = function (obj, attr, val){
...
// 碰撞检测函数
qy.duang=function (current, target){
...
// 鼠标滚轮事件
qy.wheelEvent = function (obj, fnUp, fnDown){
 ...
 * 拷贝继承
 */
qy.extend = function extend(target, data, strict){
  let obj = target || {};
  for(let key in data){
...
qy.Tween = {
	...
	bounceIn: function(t, b, c, d){    //弹球减振（弹球渐出）
		return c - qy.Tween['bounceOut'](d-t, 0, c, d) + b;
	},
	...
	bounceBoth: function(t, b, c, d){
		if (t < d/2) {
			return qy.Tween['bounceIn'](t*2, 0, c, d) * 0.5 + b;
		}
		return qy.Tween['bounceOut'](t*2-d, 0, c, d) * 0.5 + c*0.5 + b;
	}
}